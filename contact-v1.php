...
<head>
	...
	<title>GTF CONTABILIDADE - CONTATO</title>
				...
				<div class="navbar-collapse collapse" id="navbarCollapse">
					<ul class="navbar-nav navbar-nav-scroll dropdown-hover mx-auto">
						...
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle " href="#" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Home</a>
						...
						<!-- Nav item -->
						<li class="nav-item "> <a class="nav-link active" href="contact-v1.php">Contato</a> </li>
					</ul>
				</div>
				<!-- Main navbar END -->
	...
	<div class="container">
		<div class="row g-4 g-xxl-5">
			<div class="col-xl-9 mx-auto">
				<!-- Image -->
				<img src="https://i.imgur.com/Bc82Zxr.png" class="rounded" alt="contact-bg">
					...
					<div class="col-11 col-lg-9 mx-auto">
						<div class="card shadow p-4 p-sm-5 p-md-6">
							...
							<div class="card-header border-bottom px-0 pt-0 pb-5">
								...
								<!-- Title -->
								<h1 class="mb-3 h3">Vamos elevar o nível da sua empresa, juntos!</h1>
								<p class="mb-0">Você pode entrar em contato conosco a qualquer momento através <a href="mailto:contato@gtfcontabilidade.com.br">contato@gtfcontabilidade.com.br</a></p>
							</div>
							<!-- Card body & form -->
							<form class="card-body px-0 pb-0 pt-5">
								<!-- Name -->
								<div class="input-floating-label form-floating mb-4">
									<input type="text" class="form-control bg-transparent" id="floatingName" placeholder="Nome">
									<label for="floatingName">Nome</label>
								</div>
								<!-- Email -->
								<div class="input-floating-label form-floating mb-4">
									<input type="email" class="form-control bg-transparent" id="floatingInput" placeholder="name@examplo.com">
									<label for="floatingInput">Email</label>
								</div>
								<!-- Number -->
								<div class="input-floating-label form-floating mb-4">
									<input type="text" class="form-control bg-transparent" id="floatingNumber" placeholder="Telefone">
									<label for="floatingNumber">Telefone</label>
								</div>
								<!-- Message -->
								<div class="input-floating-label form-floating mb-4">
								...
								<!-- Button -->
								<button class="btn btn-lg btn-primary mb-0">Enviar</button>
							</form>
						</div>
					</div>
				</div>
		...
		<div class="row row-cols-1 row-cols-lg-3 g-4">
			...
			<div class="col">
				<div class="card card-body bg-light border p-sm-5">
					...
					<!-- Title -->
					<h6 class="mb-4">Endereço do escritório</h6>
					<!-- Office item -->
				
					<address class="mb-0">Av. Monteiro Lobato, 9960 - Balneario Regina Maria - Mongaguá/SP</address>
					<br>
					<address class="mb-0">Av. Ana Costa, 61, Gonzaga - Santos/SP</address>
				</div>
			</div>
			...
			<div class="col">
				<div class="card card-body bg-light border p-sm-5">
					...
					<p>Entraremos em contato com você em 1 a 2 dias úteis.</p>
					<a href="mailto:contato@gtfcontabilidade.com.br" class="heading-color text-primary-hover text-decoration-underline mb-0">contato@gtfcontabilidade.com.br</a>
				</div>
			</div>
			...
			<div class="col">
				<div class="card card-body bg-light border p-sm-5">
					...
					<a href="tel:+551333030540" class="heading-color text-primary-hover text-decoration-underline mb-0">(13) 3303-0540</a>
				</div>
			</div>
			<iframe width="820" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" id="gmap_canvas" src="https://maps.google.com/maps?width=520&amp;height=400&amp;hl=en&amp;q=Av.%20Monteiro%20Lobato,%209960%20-%20Balneario%20Regina%20Maria%20-%20Mongagu%C3%A1/SP%20Mongagua+(GTF%201)&amp;t=k&amp;z=17&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe> <a href='http://maps-generator.com/pt'></a> <script type='text/javascript' src='https://embedmaps.com/google-maps-authorization/script.js?id=457d5cf300188d0b582985219041e6df2a94ab38'></script>
				<br>
				<iframe width="820" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" id="gmap_canvas" src="https://maps.google.com/maps?width=520&amp;height=400&amp;hl=en&amp;q=Av.%20Ana%20Costa,%2061,%20Gonzaga%20-%20Santos/SP%20Mongagua+(GTF%201)&amp;t=k&amp;z=17&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe> <a href='http://maps-generator.com/pt'></a> <script type='text/javascript' src='https://embedmaps.com/google-maps-authorization/script.js?id=97cb5c861da5f5c6aa85ae189a054f27a5c48cf0'></script>
		</div> <!-- Row END -->
	</div>
