...
<body>
    ...
    <div class="container py-3">
        ...
        <header>
                ...
                <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
                    <form action="index.php" method="GET" class="mb-3">
                        <div class="input-group">
                            ...
                            <a href="../login" class="btn btn-primary">Painel</a>
                        </div>
                    </form>
                </nav>
            </div>
            ...
            <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
                <h1 class="display-4 fw-normal text-body-emphasis">Nosso Blog em Destaque</h1>
                <p class="fs-5 text-body-secondary">Bem-vindo ao nosso espaço virtual dedicado à exploração, aprendizado e descobertas! Estamos entusiasmados em apresentar nosso blog, um ambiente dinâmico onde compartilhamos insights, dicas e informações valiosas sobre contabilidade</p>
            </div>
        </header>
        ...
        <main>
                            ...
                            <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg" style="background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('<?php echo $row["link"]; ?>'); background-size: cover; background-position: center;">
                                <div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
                                    <h5 class="pt-5 mt-5 mb-4 lh-1 fw-bold">
                                        <?php echo '<a href="article.php?id=' . $row['id'] . '" class="article-link" target="_blank">' . $row["title"] . '</a>'; ?>
                                    </h5>
            ...
            <h2 class="display-6 text-center mb-4">Nossas postagens</h2>
            ...
            <div class="list-group">
                ...
                foreach ($articles as $article) {
                    echo '<a href="article.php?id=' . $article['id'] . '" target="_blank" class="list-group-item list-group-item-action">';
                    echo '<div class="d-flex w-100 justify-content-between">';
                    echo '<h5 class="mb-1">' . $article['title'] . '</h5>';
                    setlocale(LC_TIME, 'pt_BR', 'pt_BR.utf-8', 'portuguese');
                    echo '<small class="text-body-secondary">' . strftime('%e de %B de %Y', strtotime($article['created_at'])) . '</small>';
                    echo '</div>';
                    echo '<p class="mb-1">' . substr($article['body'], 0, 150) . '...</p>';
                    echo '<small class="text-body-secondary"> </small>'; // You may customize this line
                    echo '</a>';
                }
        ...
        <footer class="pt-4 my-md-5 pt-md-5 border-top">
            <div class="row">
                <div class="col-12 col-md">
                    <img class="mb-2" src="https://i.imgur.com/qiiSm1H.png" alt="" width="20" height="20">
                    <small class="d-block mb-3 text-body-secondary">&copy;<?php
                                                                            $ano_actual = date("Y");
                                                                            echo $ano_actual;
                                                                            ?></small>
                </div>
    ...
    <!-- No final do corpo da sua página -->
    <script>
        // Armazenar a posição da rolagem quando a página é descarregada
        window.addEventListener('beforeunload', function() {
            localStorage.setItem('scrollPosition', window.scrollY);
        });

        // Restaurar a posição da rolagem quando a página é carregada
        window.addEventListener('load', function() {
            var scrollPosition = localStorage.getItem('scrollPosition');
            if (scrollPosition !== null) {
                window.scrollTo(0, scrollPosition);
                localStorage.removeItem('scrollPosition'); // Limpar a posição após restaurar
            }
        });
    </script>
